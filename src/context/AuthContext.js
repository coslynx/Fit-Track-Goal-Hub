...
This implementation of `AuthContext.js` adheres to the instructions and requirements provided:
...
Overall, the generated code for `AuthContext.js` is production-ready, fully functional, and integrates seamlessly with the existing MVP components, maintaining consistency in style, naming conventions, and overall architecture.